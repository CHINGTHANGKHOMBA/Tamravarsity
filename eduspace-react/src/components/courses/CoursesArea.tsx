                ...
                <div className="courses-card-items style-2">
                  <Link to="https://courses.lamzingtech.com/course/view.php?id=41">
                    ...
                    <div className="courses-content">
                      ...
                      <h3>
                        <Link to="">Learn With Advance Web Development</Link>
                      </h3>
                      ...
                      <ul className="post-class">
                        <li>
                          <Link
                            to="https://courses.lamzingtech.com/course/view.php?id=41"
                            className="theme-btn"
                          >
                            Enroll Now
                          </Link>
                ...
                <div className="courses-card-items style-2">
                  <Link to="https://courses.lamzingtech.com/course/view.php?id=26">
                    ...
                    <div className="courses-content">
                      ...
                      <h3>
                        <Link to="">Advance Your Web Development Skills</Link>
                      </h3>
                      {/* <div className="client-items">
                                        <div className="client-img bg-cover" style={{background: `url(/assets/img/courses/client-1.png)`}}></div>
                                        <p>Raikumar</p>
                      ...
                      <ul className="post-class">
                        ...
                        <li>
                          <Link
                            to="https://courses.lamzingtech.com/course/view.php?id=26"
                            className="theme-btn"
                          >
                            Enroll Now
                          </Link>
                ...
                <div className="courses-card-items style-2">
                  <Link to="https://courses.lamzingtech.com/course/view.php?id=27">
                    ...
                    <div className="courses-content">
                      ...
                      <h3>
                        {/* /courses-details */}
                        <Link to="">Advance Your Career in Data Analysis</Link>
                      </h3>
                      {/* <div className="client-items">
                                        <div className="client-img bg-cover" style={{background: `url(/assets/img/courses/client-1.png)`}}></div>
                                        <p>Bronson</p>
                      ...
                      <ul className="post-class">
                        ...
                        <li>
                          <Link
                            to="https://courses.lamzingtech.com/course/view.php?id=27"
                            className="theme-btn"
                          >
                            Enroll Now
                          </Link>
                  ...
                  <Link to="https://courses.lamzingtech.com/course/view.php?id=28">
                    ...
                    <div className="courses-content">
                      ...
                      <ul className="post-class">
                        ...
                        <li>
                          <Link
                            to="https://courses.lamzingtech.com/course/view.php?id=28"
                            className="theme-btn"
                          >
                            Enroll Now
                          </Link>
                ...
                <div className="courses-card-items style-2">
                  <Link to="https://courses.lamzingtech.com/course/view.php?id=29">
                    ...
                    <div className="courses-content">
                      ...
                      <h3>
                        <Link to="">Foundation course in AI Applications</Link>
                      </h3>
                      {/* <div className="client-items">
                                        <div className="client-img bg-cover" style={{background: `url(/assets/img/courses/client-1.png)`}}></div>
                                        <p>Chingkhei</p>
                      ...
                      <ul className="post-class">
                        ...
                        <li>
                          <Link
                            to="https://courses.lamzingtech.com/course/view.php?id=29"
                            className="theme-btn"
                          >
                            Enroll Now
                          </Link>
                  ...
                  <Link to="https://courses.lamzingtech.com/course/view.php?id=30">
                    ...
                    <div className="courses-content">
                      ...
                      <ul className="post-class">
                        ...
                        <li>
                          <Link
                            to="https://courses.lamzingtech.com/course/view.php?id=30"
                            className="theme-btn"
                          >
                            Enroll Now
                          </Link>
                  ...
                  <Link to="https://courses.lamzingtech.com/course/view.php?id=31">
                    ...
                    <div className="courses-content">
                      ...
                      <ul className="post-class">
                        ...
                        <li>
                          <Link
                            to="https://courses.lamzingtech.com/course/view.php?id=31"
                            className="theme-btn"
                          >
                            Enroll Now
                          </Link>
                  ...
                  <Link to="https://courses.lamzingtech.com/course/view.php?id=32">
                    ...
                    <div className="courses-content">
                      ...
                      <ul className="post-class">
                        ...
                        <li>
                          <Link
                            to="hhttps://courses.lamzingtech.com/course/view.php?id=32"
                            className="theme-btn"
                          >
                            Enroll Now
                          </Link>
                ...
                <div className="courses-card-items style-2">
                  <Link to="https://courses.lamzingtech.com/course/view.php?id=33">
                    ...
                    <div className="courses-content">
                      ...
                      <h3>
                        <Link to="">Computer Applications Associate(CAA)</Link>
                      </h3>
                      {/* <div className="client-items">
                                        <div className="client-img bg-cover" style={{background: `url(/assets/img/courses/client-1.png)`}}></div>
                                        <p>Nehru</p>
                      ...
                      <ul className="post-class">
                        ...
                        <li>
                          <Link
                            to="https://courses.lamzingtech.com/course/view.php?id=33"
                            className="theme-btn"
                          >
                            Enroll Now
                          </Link>
                  ...
                  <Link to="https://courses.lamzingtech.com/course/view.php?id=34">
                    ...
                    <div className="courses-content">
                      ...
                      <ul className="post-class">
                        ...
                        <li>
                          <Link
                            to="https://courses.lamzingtech.com/course/view.php?id=34"
                            className="theme-btn"
                          >
                            Enroll Now
                          </Link>
                ...
                <div className="courses-card-items style-2">
                  <Link to="https://courses.lamzingtech.com/course/view.php?id=35">
                    ...
                    <div className="courses-content">
                      ...
                      <br />
                      <h3>
                        <Link to="">Cloud Computing Assistant</Link>
                      </h3>
                      {/* <div className="client-items">
                                        <div className="client-img bg-cover" style={{background: `url(/assets/img/courses/client-1.png)`}}></div>
                                        <p>Nehru</p>
                      ...
                      <ul className="post-class">
                        ...
                        <li>
                          <Link
                            to="https://courses.lamzingtech.com/course/view.php?id=35"
                            className="theme-btn"
                          >
                            Enroll Now
                          </Link>
                ...
                <div className="courses-card-items style-2">
                  <Link to="https://courses.lamzingtech.com/course/view.php?id=36">
                    ...
                    <div className="courses-content">
                      ...
                      <h3>
                        <Link to="">Junior Cloud Computing Associate</Link>
                      </h3>
                      {/* <div className="client-items">
                                        <div className="client-img bg-cover" style={{background: `url(/assets/img/courses/client-1.png)`}}></div>
                                        <p>Nehru</p>
                      ...
                      <ul className="post-class">
                        ...
                        <li>
                          <Link
                            to="https://courses.lamzingtech.com/course/view.php?id=36"
                            className="theme-btn"
                          >
                            Enroll Now
                          </Link>
                ...
                <div className="courses-card-items style-2">
                  <Link to="https://courses.lamzingtech.com/course/view.php?id=37">
                    ...
                    <div className="courses-content">
                      ...
                      <h3>
                        <Link to="">Cloud Computing Associate</Link>
                      </h3>{" "}
                      <br />
                      {/* <div className="client-items">
                                        <div className="client-img bg-cover" style={{background: `url(/assets/img/courses/client-1.png)`}}></div>
                      ...
                      <ul className="post-class">
                        ...
                        <li>
                          <Link
                            to="https://courses.lamzingtech.com/course/view.php?id=37"
                            className="theme-btn"
                          >
                            Enroll Now
                          </Link>
              ...
              <div className="courses-card-main-items">
                <div className="courses-card-items style-2">
                  ...
                  <div className="courses-content">
                    ...
                    <h3>
                      <Link to="">Artificial Intelligence Assistant</Link>
                    </h3>
                    {/* <div className="client-items">
                                        <div className="client-img bg-cover" style={{background: `url(/assets/img/courses/client-1.png)`}}></div>
                                        <p>Nehru</p>
                    ...
                    <ul className="post-class">
                      ...
                      <li>
                        <Link
                          to="https://courses.lamzingtech.com/course/view.php?id=38"
                          className="theme-btn"
                        >
                          Enroll Now
                        </Link>
                ...
                <div className="courses-card-items style-2">
                  <Link to="https://courses.lamzingtech.com/course/view.php?id=39">
                    ...
                    <div className="courses-content">
                      ...
                      <h3>
                        <Link to="">Artificial Intelligence Associate</Link>
                      </h3>
                      {/* <div className="client-items">
                                        <div className="client-img bg-cover" style={{background: `url(/assets/img/courses/client-1.png)`}}></div>
                                        <p>Nehru</p>
                      ...
                      <ul className="post-class">
                        ...
                        <li>
                          <Link
                            to="https://courses.lamzingtech.com/course/view.php?id=39"
                            className="theme-btn"
                          >
                            Enroll Now
                          </Link>
                  ...
                  <Link to="https://courses.lamzingtech.com/course/view.php?id=40">
                    <div className="courses-image">
                      <img
                        ...
                        alt="AIApplicationDeveloper.jpg"
                      />
                    ...
                    <div className="courses-content">
                      ...
                      <ul className="post-class">
                        ...
                        <li>
                          <Link
                            to="https://courses.lamzingtech.com/course/view.php?id=40"
                            className="theme-btn"
                          >
                            Enroll Now
                          </Link>
