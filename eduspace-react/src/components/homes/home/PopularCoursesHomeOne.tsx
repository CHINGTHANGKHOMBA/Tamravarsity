                        ...
                        <div className="row">
                            <div className="col-xxl-3 col-xl-4 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay=".2s">
                                <div className="courses-card-main-items">
                                    <div className="courses-card-items">
                                        ...
                                        <img src="assets/img/courses/ReactJS.png" alt="img" />
                                    ...
                                    <div className="courses-card-items-hover">
                                        <div className="courses-content">
                                            ...
                                            {/* <h4>$85</h4> */} <br />
                                            <span>
                                            ReactJS is a JavaScript library for building 
                            ...
                            <div className="col-xxl-3 col-xl-4 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay=".4s">
                                <div className="courses-card-main-items">
                                    <div className="courses-card-items">
                                        <div className="courses-image">
                                        <img src="assets/img/courses/CertifiedWebDeveloper.png" alt="img" />
                                            <h3 className="courses-title"> </h3>
                                    ...
                                    <div className="courses-card-items-hover">
                                        <div className="courses-content">
                                            ...
                                            {/* <h4>$85</h4> */} <br />
                                            <span>
                                            A web developer designs, builds, & maintains 
                                ...
                                <div className="courses-card-main-items">
                                    <div className="courses-card-items">
                                        ...
                                        <img src="assets/img/courses/AIApplications.png" alt="AIApplications" />
                                            ...
                                            <h4 className="topic-title">Foundation course in Artificial Intelligence Applications</h4> */}
                                            <div className="arrow-items">
                                                <div className="GlidingArrow">
                                                    <img src="assets/img/courses/a1.png" alt="img" />
                                                </div>
                                    ...
                                    <div className="courses-card-items-hover">
                                        <div className="courses-content">
                                            ...
                                            {/* <h4>$85</h4> */} <br />
                                            <span>
                                            AI applications enable computers to think and act like humans.
                                            </span>
                                            {/* <div className="client-items">
                                                <div className="client-img bg-cover" style={{background: `url(assets/img/courses/client-1.png)`}}></div>
                                                <p>Paul C. Deleon</p>
                                ...
                                <div className="courses-card-main-items">
                                    <div className="courses-card-items">
                                        ...
                                        <img src="assets/img/courses/AIAssociate.png" alt="AIAssociate" />
                                            ...
                                            <h4 className="topic-title">Certified Artificial Intelligence (AI) Associate "Upskilling"</h4> */}
                                            <div className="arrow-items">
                                                <div className="GlidingArrow">
                                                    <img src="assets/img/courses/a1.png" alt="img" />
                                                </div>
                                        ...
                                        <div className="courses-content">
                                            ...
                                            <h5>
                                                <Link to="">
                                                Certified AI Associate "Upskilling"
                                                </Link>
                                            </h5>
                                            {/* <div className="client-items">
                                                <div className="client-img bg-cover" style={{background: `url(assets/img/courses/client-1.png)`}}></div>
                                    ...
                                    <div className="courses-card-items-hover">
                                        <div className="courses-content">
                                            ...
                                            {/* <h4>$85</h4> */} <br />
                                            <span>
                                            An AI Associate upskills by leveraging AI to enhance skills, 
                                            automate tasks, & boost decision-making.
                                            </span>
                                            {/* <div className="client-items">
                                                <div className="client-img bg-cover" style={{background: `url(assets/img/courses/client-1.png)`}}></div>
                                                <p>Paul C. Deleon</p>
                                ...
                                <div className="courses-card-main-items">
                                    <div className="courses-card-items">
                                        ...
                                        <img src="assets/img/courses/AndroidApps.png" alt="AndroidApps" />
                                            {/* <h3 className="courses-title">Android Apps</h3>
                                            <h4 className="topic-title">Certified Android Apps Developer (Upskilling)</h4> */}
                                            <div className="arrow-items">
                                                <div className="GlidingArrow">
                                                    <img src="assets/img/courses/a1.png" alt="img" />
                                                </div>
