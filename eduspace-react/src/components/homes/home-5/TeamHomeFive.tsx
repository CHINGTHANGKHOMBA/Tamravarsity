                ...
                <div className="row">
                    <div className="col-xl-3 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay=".2s">
                        <div className="team-card-items">
                            ...
                            <div className="content">
                                <h4><Link to="/instructor-details">William K. Swanson</Link></h4>
                    ...
                    <div className="col-xl-3 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay=".4s">
                        <div className="team-card-items">
                            ...
                            <div className="content">
                                <h4><Link to="/instructor-details">Douglas A. Braxton</Link></h4>
                                <p>Business Instructors</p>
                            </div>
                        </div>
                    </div>
                    <div className="col-xl-3 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay=".6s">
                        <div className="team-card-items">
                            ...
                            <div className="content">
                                <h4><Link to="/instructor-details">Matthew M. Moore</Link></h4>
                                <p>Business Instructors</p>
                            </div>
                        </div>
                    </div>
                    <div className="col-xl-3 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay=".8s">
                        <div className="team-card-items">
                            ...
                            <div className="content">
                                <h4><Link to="/instructor-details">Bernard A. McKenzie</Link></h4>
                                <p>Business Instructors</p>
                            </div>
                        </div>
                    </div>
